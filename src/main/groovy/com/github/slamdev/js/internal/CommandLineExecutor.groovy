package com.github.slamdev.js.internal
...
class CommandLineExecutor {
    ...
    void exec(Path logTo, String prefix, String command, Path workingDirectory = null, boolean failOnError = true) {
        ExecResult result = project.exec { ExecSpec spec ->
            prepareSpec(spec, workingDirectory, command)
    ...
    private static prepareSpec(ExecSpec spec, Path workingDirectory, String command) {
        ...
        if (workingDirectory != null) {
            execAction.workingDir(workingDirectory.toFile())
        }
    }
